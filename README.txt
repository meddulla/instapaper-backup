...
Fetches the rss from the instapaper rss and for each url saves the actual content to disk. Change settings.py with your own instapaper feed url and the path to save the html downloaded files to.
...
Of course, it could also work for any rss and/or csv (that follows the same structure).
